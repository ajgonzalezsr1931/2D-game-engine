...
public class Gizmo extends Component {
	...
	private Vector2f xAxisOffset = new Vector2f(60, -5);
	...
	private boolean checkXHoverState() {
		...
		if (mousePos.x <= xAxisObject.transform.position.x && //right x
				mousePos.x >= xAxisObject.transform.position.x - gizmoHeight && //left x 
				mousePos.y >= xAxisObject.transform.position.y && //top y
				mousePos.y <= xAxisObject.transform.position.y + gizmoWidth) { //bottom y
